...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { currency: @price.currency, model_id: @price.model_id, price: @price.price } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { currency: @price.currency, model_id: @price.model_id, price: @price.price } }
